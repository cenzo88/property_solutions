        ...
        <nav class="navbar navbar-default ">
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<?= base_url('index.php')?>"><img src="<?= base_url('')?>assets/img/logo.png" alt=""></a>
                </div>
                ...
                <div class="collapse navbar-collapse yamm" id="navigation">
                    ...
                    <ul class="main-nav nav navbar-nav navbar-right">
                       <li class="wow fadeInDown" data-wow-delay="0.2s"><a class="" href="<?= base_url('index.php')?>">Home</a></li>
            ...
            <div class="container">
                <div class="row">
                    <div class="page-head-content">
                        <h1 class="page-title">Home New account / Create Account </h1>               
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="col-md-8 col-md-offset-2 col-xs-12 login-blocks">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name = "fname" id="validationCustom01" placeholder="Firstname name" required="required">
                                    </div>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name = "lname" id="validationCustom02" placeholder="Last name" required="required">
                                    </div>
                                    </div>
                                <div class="form-group">
